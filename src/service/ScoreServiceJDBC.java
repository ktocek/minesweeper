...
public class ScoreServiceJDBC implements ScoreService {
    ...
    private static final String STATEMENT_BEST_SCORE = "SELECT game, username, points, played_on FROM score WHERE game= ? ORDER BY points DESC LIMIT 5;";
    ...
    public List<Score> getBestScores(String game) {
        ...
        try (var connection = DriverManager.getConnection("jdbc:postgresql://localhost/gamestudio", "postgres", "postgres");
             var statement = connection.prepareStatement(STATEMENT_BEST_SCORE)
        ) {
